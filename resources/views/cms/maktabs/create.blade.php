            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Custom Styled Validation -->
                     <form id="formMaktab" class="row g-3 needs-validation" action="{{ route('admin.maktabs.store') }}" method="POST" novalidate>
                        @csrf
                        <!-- Sektor -->
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="host_name" id="host_name" class="form-control" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="host_phone" id="phone" class="form-control" required>
...
<script>
    $(document).ready(function () {
        ...
        // Ini masih tetap digunakan jika user pilih manual coordinator
        $('#coordinator_id').on('change', function () {
            const id = $(this).val();
            const coordinatorUrl = `{{ route('admin.maktab.coor-data', ['id' => '__ID__']) }}`.replace('__ID__', id);
